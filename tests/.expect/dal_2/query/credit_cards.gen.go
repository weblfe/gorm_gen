...
// WithContext method
func (c *creditCards) WithContext(ctx context.Context) *creditCardsDo {
...
func (c creditCardsDo) Debug() *creditCardsDo {
	return c.withDO(c.DO.Debug())
}

func (c creditCardsDo) WithContext(ctx context.Context) *creditCardsDo {
	return c.withDO(c.DO.WithContext(ctx))
}

func (c creditCardsDo) ReadDB() *creditCardsDo {
	return c.Clauses(dbresolver.Read)
}

func (c creditCardsDo) WriteDB() *creditCardsDo {
	return c.Clauses(dbresolver.Write)
}

func (c creditCardsDo) Session(config *gorm.Session) *creditCardsDo {
	return c.withDO(c.DO.Session(config))
}

func (c creditCardsDo) Clauses(conds ...clause.Expression) *creditCardsDo {
	return c.withDO(c.DO.Clauses(conds...))
}

func (c creditCardsDo) Returning(value interface{}, columns ...string) *creditCardsDo {
	return c.withDO(c.DO.Returning(value, columns...))
}

func (c creditCardsDo) Not(conds ...gen.Condition) *creditCardsDo {
	return c.withDO(c.DO.Not(conds...))
}

func (c creditCardsDo) Or(conds ...gen.Condition) *creditCardsDo {
	return c.withDO(c.DO.Or(conds...))
}

func (c creditCardsDo) Select(conds ...field.Expr) *creditCardsDo {
	return c.withDO(c.DO.Select(conds...))
}

func (c creditCardsDo) Where(conds ...gen.Condition) *creditCardsDo {
	return c.withDO(c.DO.Where(conds...))
}

func (c creditCardsDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) *creditCardsDo {
	return c.Where(field.CompareSubQuery(field.ExistsOp, nil, subquery.UnderlyingDB()))
}

func (c creditCardsDo) Order(conds ...field.Expr) *creditCardsDo {
	return c.withDO(c.DO.Order(conds...))
}

func (c creditCardsDo) Distinct(cols ...field.Expr) *creditCardsDo {
	return c.withDO(c.DO.Distinct(cols...))
}

func (c creditCardsDo) Omit(cols ...field.Expr) *creditCardsDo {
	return c.withDO(c.DO.Omit(cols...))
}

func (c creditCardsDo) Join(table schema.Tabler, on ...field.Expr) *creditCardsDo {
	return c.withDO(c.DO.Join(table, on...))
}

func (c creditCardsDo) LeftJoin(table schema.Tabler, on ...field.Expr) *creditCardsDo {
	return c.withDO(c.DO.LeftJoin(table, on...))
}

func (c creditCardsDo) RightJoin(table schema.Tabler, on ...field.Expr) *creditCardsDo {
	return c.withDO(c.DO.RightJoin(table, on...))
}

func (c creditCardsDo) Group(cols ...field.Expr) *creditCardsDo {
	return c.withDO(c.DO.Group(cols...))
}

func (c creditCardsDo) Having(conds ...gen.Condition) *creditCardsDo {
	return c.withDO(c.DO.Having(conds...))
}

func (c creditCardsDo) Limit(limit int) *creditCardsDo {
	return c.withDO(c.DO.Limit(limit))
}

func (c creditCardsDo) Offset(offset int) *creditCardsDo {
	return c.withDO(c.DO.Offset(offset))
}

func (c creditCardsDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *creditCardsDo {
	return c.withDO(c.DO.Scopes(funcs...))
}

func (c creditCardsDo) Unscoped() *creditCardsDo {
...
func (c creditCardsDo) Attrs(attrs ...field.AssignExpr) *creditCardsDo {
	return c.withDO(c.DO.Attrs(attrs...))
}

func (c creditCardsDo) Assign(attrs ...field.AssignExpr) *creditCardsDo {
	return c.withDO(c.DO.Assign(attrs...))
}

func (c creditCardsDo) Joins(fields ...field.RelationField) *creditCardsDo {
...
func (c creditCardsDo) Preload(fields ...field.RelationField) *creditCardsDo {
	for _, _f := range fields {
