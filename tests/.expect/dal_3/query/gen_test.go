...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		qCtx.Banks.UnderlyingDB().Statement.Context,
		qCtx.CreditCards.UnderlyingDB().Statement.Context,
		qCtx.Customers.UnderlyingDB().Statement.Context,
		qCtx.People.UnderlyingDB().Statement.Context,
		qCtx.Users.UnderlyingDB().Statement.Context,
	} {
