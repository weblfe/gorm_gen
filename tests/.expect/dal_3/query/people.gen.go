...
// WithContext method
func (p *people) WithContext(ctx context.Context) IPeopleDo {
...
type IPeopleDo interface {
	...
	Clauses(conditions ...clause.Expression) IPeopleDo
	Not(conditions ...gen.Condition) IPeopleDo
	Or(conditions ...gen.Condition) IPeopleDo
	Select(conditions ...field.Expr) IPeopleDo
	Where(conditions ...gen.Condition) IPeopleDo
	Order(conditions ...field.Expr) IPeopleDo
	...
	Having(conditions ...gen.Condition) IPeopleDo
...
func (p peopleDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IPeopleDo {
